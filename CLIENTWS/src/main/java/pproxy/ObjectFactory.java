 ...
 * generated in the pproxy package. 
...
public class ObjectFactory {
    ...
    private static final QName _ConversionED_QNAME = new QName("http://WS/", "conversionED");
    private static final QName _ConversionEDResponse_QNAME = new QName("http://WS/", "conversionEDResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pproxy
     * 
     */
     ...
     * 
     * @return
     *     the new instance of {@link ConversionED }
     */
     ...
     * 
     * @return
     *     the new instance of {@link ConversionEDResponse }
     */
     ...
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ConversionED }{@code >}
     */
    @XmlElementDecl(namespace = "http://WS/", name = "conversionED")
    public JAXBElement<ConversionED> createConversionED(ConversionED value) {
        return new JAXBElement<>(_ConversionED_QNAME, ConversionED.class, null, value);
    }
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ConversionEDResponse }{@code >}
     */
    ...
    public JAXBElement<ConversionEDResponse> createConversionEDResponse(ConversionEDResponse value) {
        return new JAXBElement<>(_ConversionEDResponse_QNAME, ConversionEDResponse.class, null, value);
    }
